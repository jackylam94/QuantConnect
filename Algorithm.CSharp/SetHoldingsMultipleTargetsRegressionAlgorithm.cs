...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SetHoldingsMultipleTargetsRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "364.549%"},
            {"Drawdown", "2.300%"},
            {"Expectancy", "-1"},
            {"Net Profit", "1.983%"},
            {"Sharpe Ratio", "12.312"},
            {"Probabilistic Sharpe Ratio", "66.044%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "1.051"},
            ...
            {"Sortino Ratio", "18.766"},
            {"Return Over Maximum Drawdown", "126.121"},
            ...
            {"OrderListHash", "f22df94cd954bb786419787dc8376d3d"}
        };
    }
}
