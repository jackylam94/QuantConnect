...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class PortfolioRebalanceOnCustomFuncRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.15%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "18.646%"},
            {"Drawdown", "9.300%"},
            {"Expectancy", "0"},
            {"Net Profit", "66.940%"},
            {"Sharpe Ratio", "1.744"},
            {"Probabilistic Sharpe Ratio", "87.569%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.161"},
            ...
            {"Sortino Ratio", "2.104"},
            {"Return Over Maximum Drawdown", "2.014"},
            ...
            {"OrderListHash", "569257c036b035316252ca2ac7780b2c"}
        };
    }
}
