...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class VolumeWeightedAveragePriceExecutionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.04%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "475.593%"},
            {"Drawdown", "1.200%"},
            {"Expectancy", "2.429"},
            {"Net Profit", "2.263%"},
            {"Sharpe Ratio", "12.777"},
            {"Probabilistic Sharpe Ratio", "71.681%"},
            {"Loss Rate", "32%"},
            {"Win Rate", "68%"},
            {"Profit-Loss Ratio", "4.05"},
            {"Alpha", "1.12"},
            {"Beta", "1.044"},
            {"Annual Standard Deviation", "0.25"},
            {"Annual Variance", "0.062"},
            {"Information Ratio", "13.152"},
            ...
            {"Return Over Maximum Drawdown", "542.955"},
            {"Portfolio Turnover", "0.934"},
            ...
            {"OrderListHash", "4707e19b17a711cc8232b507fc8c171c"}
        };
    }
}
