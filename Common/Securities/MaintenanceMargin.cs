...
namespace QuantConnect.Securities
{
    ...
    public class MaintenanceMargin
    {
        ...
        /// </summary>
        public static implicit operator MaintenanceMargin(decimal maintenanceMargin)
        {
            return new MaintenanceMargin(maintenanceMargin);
        }

        /// <summary>
        /// Implicit operator to decimal
        /// </summary>
        public static implicit operator decimal(MaintenanceMargin initialMargin)
        {
