...
namespace QuantConnect.Orders
{
    ...
    public static class OrderExtensions
    {
        ...
        /// <summary>
        /// Updates the provided order's quantity.
        /// TODO : When we support ComboOrder, we'll also need to modify all of the referenced orders by the same proportion as the delta
        /// </summary>
        public static Order WithQuantity(this Order order, decimal quantity)
        {
